...
def build_graph() -> StateGraph:
    ...
    graph.add_node("fetch_repo_metadata", fetch_repo_metadata)
    graph.add_node("fetch_commit_history", fetch_commit_history)
    graph.add_node("triage_commits", triage_commits)
    graph.add_node("analyze_commit", analyze_commit)
    graph.add_node("cluster_into_eras", cluster_into_eras)
    graph.add_node("synthesize_outline", synthesize_outline)
    graph.add_node("expand_to_narrative", expand_to_narrative)
