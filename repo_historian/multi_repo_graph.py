...
def build_multi_repo_graph():
    ...
    graph.add_node("write_cross_repo_narrative", write_cross_repo_narrative, retry=retry)
    ...
    graph.add_edge("collect_and_merge", "write_cross_repo_narrative")
    graph.add_edge("write_cross_repo_narrative", END)
